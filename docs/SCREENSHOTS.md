...
| [workspace-settings.png](screenshots/workspace-settings.png) | `/dashboard/settings` | Workspace identity, default visibility, uploaded moment visibility, and GPS sampling configuration. | Useful for explaining demo defaults that affect public and mobile workflows. |
| [mobile-home.png](screenshots/mobile-home.png) | Mobile Home tab | Live field-capture status, GPS quality, trip setup, and signed-in operator context. | Expo React Native screen. |
| [mobile-trips.png](screenshots/mobile-trips.png) | Mobile Trips tab | Trip history filters, mode/use segmentation, and monthly summaries. | Shows mobile review of captured trip records. |
| [mobile-trip-detail.png](screenshots/mobile-trip-detail.png) | Mobile Trip detail | Completed route map, distance, start/finish metadata, and sync status. | Shows mobile-to-web handoff data at record level. |
| [mobile-settings.png](screenshots/mobile-settings.png) | Mobile Settings tab | Screen-wake behavior, vehicle/tour setup, and troubleshooting entry points. | Shows mobile operational configuration. |
...
- Replace old images when the seed data or visual identity changes so the README stays coherent.
