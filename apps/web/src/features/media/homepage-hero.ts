...
function buildFallbackImage(index = 0): HomepageHeroSlide {
  const fallbackSlides = [
    ...
    {
      title: "Fresh tour stories, shared openly",
      subtitle: "Discover gigs, venues, and field notes published across the platform.",
      href: "/posts",
      ctaLabel: "Read the story",
    },
    {
      title: "Media from real tours",
      subtitle: "Browse photo moments from public tours and backstage updates.",
      href: "/gallery",
  ...
  return {
    ...
    attribution: "Shared by the GigEze community",
    journeyTitle: null,
    workspaceName: null,
    ownerName: null,
